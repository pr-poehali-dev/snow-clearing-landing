          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: 'Стоимость зависит от площади кровли, степени наледи и высоты здания. Очистка от снега и удаление наледи — от 55 ₽/м². Точную цену назовем после осмотра объекта.'
              },
              {
