        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                name: 'Сергей Волков',
                company: 'Частный дом, Одинцово',
                rating: 5,
                text: 'После снегопадов крыша была завалена снегом по самые трубы. Позвонил, приехали в этот же день. Работали аккуратно, цена честная. Рекомендую!',
                date: '05.02.2025'
              }
            ].map((review, index) => (
